                            ...
                            <div class="respond-box">
                                <div id="respond" class="comment-respond">
                                    <h3 id="reply-title" class="comment-reply-title">
                                        <small>
                                            <a rel="nofollow" id="cancel-comment-reply-link" href="/reviews/#respond"
                                               style="display:none;">Cancel reply</a>
                                        </small>
                                    </h3>

                                    <form action="{{ url('reviews/store')}}" method="post" id="commentform"
                                          class="comment-form">
                                        @csrf
                                        <div class="comment-form-comment">
                                            <label for="comment" class="visuallyhidden">Message:</label>
                                            <textarea id="comment" name="comment" required
                                                      placeholder="Write your comments" rows="2"></textarea>
                                        </div>
                                        <div class="second-row">
                                            <div class="comment-form-author form-input">
                                                <label for="author" class="visuallyhidden">Name:</label>
                                                <span class="required">*</span>
                                                <input id="author" autocomplete="name" name="name" type="text"
                                                       required="required" value="" size="30" placeholder="John Doe"/>
                                            </div>
                                            <div class="comment-form-email form-input">
                                                <label for="email" class="visuallyhidden">Email:</label>
                                                <span class="required">*</span>
                                                <span
                                                    class="comment-note">Your email address will not be published.</span>
                                                <input id="email" autocomplete="email" name="email" type="email"
                                                       required="required" value="" size="30"
