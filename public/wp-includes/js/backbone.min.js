...
!function(n) {
    ...
    var o, i = t.Backbone, u = Array.prototype.slice, e = (h.VERSION = "1.4.1",
    h.$ = e,
        ...
        set: function(t, e, i) {
            if (null != t) {
                ...
                !this._validate(n, i = i || {}))
                    return !1;
                var s, r, o = i.unset, t = i.silent, h = [], a = this._changing, u = (this._changing = !0,
                a || (this._previousAttributes = b.clone(this.attributes),
                this.changed = {}),
                this.attributes), c = this.changed, l = this._previousAttributes;
                for (s in n)
                    e = n[s],
    ...
    h.Collection = function(t, e) {
        ...
        set: function(t, e) {
            if (null != t) {
                ...
                []), r = [], o = [], h = [], a = {}, u = e.add, c = e.merge, l = e.remove, d = !1, f = this.comparator && null == n && !1 !== e.sort, p = b.isString(this.comparator) ? this.comparator : null, g = 0; g < t.length; g++) {
    ...
    ), I = 1, k = 2, S = 3, y = (y && (E.prototype[y] = function() {
        return this
    }
    ),
    E.prototype.next = function() {
        if (this._collection) {
            ...
            if (this._index < this._collection.length)
                ...
                this._index++,
                {
                    value: this._kind === I ? t : (e = this._collection.modelId(t.attributes, t.idAttribute),
                    this._kind === k ? e : [e, t]),
                    done: !1
                };
    ...
    ), A = /^(\S+)\s*(.*)$/, T = ["model", "collection", "el", "id", "attributes", "className", "tagName", "events"], P = (b.extend(y.prototype, e, {
        tagName: "div",
        $: function(t) {
    ...
    h.sync = function(t, e, n) {
        ...
        }),
        {
            type: s,
            dataType: "json"
        }), o = (n.url || (r.url = b.result(e, "url") || M()),
    ...
    ), C = /\((.*?)\)/g, j = /(\(\?)?:\w+/g, O = /\*\w+/g, U = /[\-{}\[\]+?.,\\\^$|#\s]/g, R = (b.extend($.prototype, e, {
        preinitialize: function() {},
        initialize: function() {},
    ...
    h.history = new R,
    v.extend = m.extend = $.extend = y.extend = R.extend = function(t, e) {
        var i = this
