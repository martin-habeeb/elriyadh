!function() {
    var e, t, i;
    !function(n) {
        var r, o, l, a, s = {}, d = {}, c = {}, f = {}, u = Object.prototype.hasOwnProperty, h = [].slice, m = /\.js$/;
        function g(e, t) {
            return u.call(e, t)
        }
        function p(e, t) {
            var i, n, r, o, l, a, s, d, f, u, h, g = t && t.split("/"), p = c.map, v = p && p["*"] || {};
            if (e) {
                for (l = (e = e.split("/")).length - 1,
        ...
        l = function(e, t) {
            var i, n, r = R(e), o = r[0], l = t[1];
            return e = r[1],
            o && (i = b(o = p(o, l))),
            o ? e = i && i.normalize ? i.normalize(e, (n = l,
            function(e) {
                return p(e, n)
            }
            )) : p(e, l) : (o = (r = R(e = p(e, l)))[0],
            e = r[1],
            o && (i = b(o))),
            {
                f: o ? o + "!" + e : e,
        ...
        return Marionette.Object.extend({
            ...
            emailKeyup: function(e, n, r) {
                ...
                if (0 == o.length)
                    ...
                    t.test(o) && (nfRadio.channel("fields").request("remove:error", l, i),
                    ...
                    nfRadio.channel("fields").request("add:error", l, i, s.get("settings").changeEmailErrorMsg),
        ...
        return Marionette.Object.extend({
            ...
            dateChange: function(e) {
                ...
                if (0 < n.length)
                    if (moment(n, r).isValid())
                        ...
                        nfRadio.channel("fields").request("add:error", i, t, l.get("settings").changeDateErrorMsg)
                    }
                else
                    nfRadio.channel("fields").request("remove:error", i, t)
            },
            dateKeyup: function(e, i, n) {
                ...
                0 == r.length)
                    ...
                    moment(r, l).isValid() && (nfRadio.channel("fields").request("remove:error", o, t),
        ...
        return Marionette.Object.extend({
            ...
            renderOptions: function() {
                ...
                var i = this
                  ...
                  , r = 1
                  , o = 1;
                if (_.each(this.image_options, (function(l, a) {
                    this.show_option_labels ? l.label = void 0 !== nfFrontEnd.filter_esc_status && "true" === nfFrontEnd.filter_esc_status ? _.escape(l.label) : l.label : l.label = "",
                    Array.isArray(this.value) && (Array.isArray(this.value[0]) && -1 !== _.indexOf(this.value[0], l.value) || _.indexOf(this.value, l.value)) && (t = !0),
                    l.value == this.value && (t = !0),
                    void 0 === l.visible && (l.visible = !0),
                    "horizontal" === i.list_orientation && r <= n && (l.styles = "margin:auto;grid-column: " + r + "; grid-row = " + o,
                    r === n ? (r = 1,
                    o += 1) : r += 1),
                    ...
                    l.index = a;
                    var s = !1;
                    Array.isArray(this.value) && 0 < this.value.length ? -1 === _.indexOf(this.value[0].split(","), l.value) && -1 === _.indexOf(this.value, l.value) || (s = !0) : (_.isArray(this.value) || l.value != this.value) && (1 != l.selected || !this.clean || void 0 !== this.value && "" !== this.value) || (s = !0),
                    l.selected = s,
                    l.isSelected = s,
                ...
                1 == this.show_other) {
                    ...
                    var l = {
                      ...
                      , a = nfRadio.channel("app").request("get:template", "#tmpl-nf-field-listimage-other");
                    e += a(l)
                }
                return e
            },
        ...
        return Marionette.Object.extend({
            ...
            validateMinMax: function(e, t) {
                ...
                if (l && n && 0 != d % c) {
                    a = nfRadio.channel("fields").request("get:field", t.get("id")),
                    s = nfRadio.channel("app").request("get:form", a.get("formID"));
                    nfRadio.channel("fields").request("add:error", t.get("id"), "number-step", s.get("settings").fieldNumberIncrementBy + l)
                } else
        ...
        return Marionette.Object.extend({
            ...
            changeValue: function(i) {
                ...
                if ("" == n.get("value") || n.get("value") == r.get("value"))
                    ...
                    nfRadio.channel("fields").request("add:error", o, t, a.get("settings").confirmFieldErrorMsg)
                }
            },
            confirmKeyup: function(e, i, n) {
                ...
                if (i.get("confirm_field"))
                    var o = i
                      , l = i.get("id")
                      , a = nfRadio.channel("form-" + i.get("formID")).request("get:fieldByKey", o.get("confirm_field")).get("value")
                      , s = r;
                else if (i.get("confirm_with"))
                    l = (o = nfRadio.channel("fields").request("get:field", i.get("confirm_with"))).get("id"),
                    a = s = o.get("value");
                if (void 0 !== o)
                    if ("" == s)
                        ...
                        nfRadio.channel("fields").request("add:error", l, t, c.get("settings").confirmFieldErrorMsg)
                    }
            }
        })
    }
    ...
    i("controllers/submitButton", ["controllers/submitButton"], (function(e) {
        return Marionette.Object.extend({
            ...
            processingLabel: function() {
                if (this.get("label") == this.get("processing_label"))
                    return !1;
        ...
        return Marionette.Object.extend({
            ...
            validateRequired: function(e, t) {
                ...
                var i = jQuery(e).val()
                  ...
                  , r = !0
                  , o = t.get("mask");
                if (o && (o = (o = (o = o.replace(/9/g, "_")).replace(/a/g, "_")).replace(/\*/g, "_")),
        ...
        return Marionette.Object.extend({
            ...
            actionSubmit: function(e) {
                if (0 == _.size(e.errors) && void 0 !== e.data.actions && void 0 !== e.data.actions.success_message && "" != e.data.actions.success_message) {
                    ...
                    const a = e.data.actions.success_message.replace(/(<([^>]+)>)/gi, "");
                    i.attr("tabindex", "0"),
                    ...
                    o > r && l < n || jQuery("html, body").animate({
        ...
        return Marionette.Object.extend({
            ...
            onFormLoaded: function(e) {
                ...
                for (var a in i) {
                    ...
                    n[a] ? d *= n[a].get("value") : 1 == s.get("product_use_quantity") && (d *= s.get("value")),
        ...
        return Marionette.Object.extend({
            ...
            getCalcValue: function(e) {
                ...
                var n = new r(nfi18n.siteLocale,nfi18n.thousands_sep,nfi18n.decimal_point)
                  , o = n.numberDecoder(i)
                  , l = n.numberEncoder(i);
                return t = void 0 !== o && jQuery.isNumeric(o) ? l : 0,
                e.get("visible") || (t = 0),
                t
            },
            ...
            updateDisplayFields: function(e) {
                ...
                void 0 !== this.displayFields[e.get("name")] && _.each(this.displayFields[e.get("name")], (function(i) {
                    ...
                    _.each(o, (function(e) {
                        ...
                        n = "html" === i.get("type") ? n.replace(l, '<span data-key="calc:' + r + '">' + a + "</span>") : a
                    }
                    )),
                    i.set("value", n),
    ...
    i("controllers/fieldDate", [], (function() {
        return Marionette.Object.extend({
            ...
            initDatepicker: function(e) {
                ...
                "" != i && "default" != i || (i = this.convertDateFormat(nfi18n.dateFormat),
        ...
        return Marionette.Object.extend({
            ...
            nf_build_default_consent_action: function(e, t, i, n) {
                if (!(t.length <= 1 && t.includes("missing_cookie") || t.length <= 0)) {
                    ...
                    const l = document.getElementsByClassName("nf-error-recaptcha-v3-missing");
            ...
            updateFieldMergeTags: function(e) {
                _.each(this.htmlFields, (function(e) {
                    ...
                    _.each(this.trackedMergeTags, (function(e) {
                        ...
                        const r = "object" == typeof e.getValue() ? this.displayRepeaterData(e) : e.getValue();
    ...
    i("views/fieldItem", [], (function() {
        return Marionette.ItemView.extend({
            ...
            onRender: function() {
                ...
                void 0 !== this.model.get("mask") && "" != jQuery.trim(this.model.get("mask"))) {
            ...
            templateHelpers: function() {
                ...
                return {
                    ...
                    renderWrapClass: function() {
                        ...
                        void 0 !== this.old_classname && 0 < jQuery.trim(this.old_classname).length && (e += " " + this.old_classname + "-wrap"),
                    ...
                    renderClasses: function() {
                        ...
                        void 0 !== this.element_class && 0 < jQuery.trim(this.element_class).length && (e += " " + this.element_class),
                    ...
                    maybeRenderHelp: function() {
                        ...
                        var t = !1;
                        if ((0 != jQuery.trim(jQuery(e).text()).length || 0 < jQuery(e).find("img").length) && (t = !0),
                    ...
                    renderDescText: function() {
                        ...
                        0 == jQuery.trim(r.innerText).length ? "" : (t = document.createTextNode(this.desc_text),
                        (e = document.createElement("p")).appendChild(t),
                        0 != jQuery.trim(jQuery(e).text()).length ? (i = document.createRange().createContextualFragment(this.desc_text),
            ...
            templateHelpers: function() {
                return {
                    renderContainerClass: function() {
                        ...
                        void 0 !== this.container_class && 0 < jQuery.trim(this.container_class).length && (e += this.container_class + " "),
    ...
    i("models/fieldRepeaterSetModel", [], (function() {
        return Backbone.Model.extend({
            ...
            initAllRepeaterFieldsModels: function(e, t) {
                ...
                l ? l.fields = l.fields.concat(o) : n.push({
                    form: i,
                    id: r,
                    fields: o
                }),
    ...
    i("views/formLayout", ["views/afterFormContent", "views/beforeFormContent", "models/fieldCollection"], (function(e, t, i) {
        return Marionette.LayoutView.extend({
            ...
            onShow: function() {
                ...
                !1 != i instanceof Backbone.Collection ? l.collection = i : !1 != i instanceof Backbone.Model && (l.model = i),
    ...
    jQuery(document).ready((function(e) {
        t(["models/formCollection", "models/formModel", "models/fieldCollection", "controllers/loadControllers", "views/mainLayout", "../nfLocaleConverter"], (function(t, i, n, o, l) {
