var wpAjaxUrl = 'https://landscaping.vamtam.com/wp-admin/admin-ajax.php';
var flBuilderUrl = 'https://landscaping.vamtam.com/wp-content/plugins/beaver-builder-lite-version/';
var FLBuilderLayoutConfig = {
    ...
    paths: {
        pluginUrl: 'https://landscaping.vamtam.com/wp-content/plugins/beaver-builder-lite-version/',
        wpAjaxUrl: 'https://landscaping.vamtam.com/wp-admin/admin-ajax.php'
    },
    breakpoints: {
        small: 768,
        medium: 992,
...
(function($) {
    ...
    FLBuilderLayout = {
        ...
        _initVimeoBgVideo: function() {
            var playerWrap = $(this), videoId = playerWrap.data('video-id'), videoPlayer = playerWrap.find('.fl-bg-video-player'), enableAudio = playerWrap.data('enable-audio'), audioButton = playerWrap.find('.fl-bg-video-audio'), player, width = playerWrap.outerWidth(), ua = navigator.userAgent;
